        ...
        $(document).ready(
            function() {
                ...
                $(addDateButton).click(function (e) {
                    ...
                    $(el).append('<tr><td><input name="children[]" type="hidden" value="' +dateString+ '" >' + humanDateString + '</td><td><button class="remove_date_field"><i class="fa fa-minus" aria-hidden="true"></i></button></td></tr>');
                });
